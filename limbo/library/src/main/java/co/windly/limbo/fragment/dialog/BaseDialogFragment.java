...
public abstract class BaseDialogFragment<V extends BaseDialogFragmentView, P extends BaseDialogFragmentPresenter<V>>
  extends DialogFragment implements MvpDelegateCallback<V, P>, BaseDialogFragmentView {
  ...
  @Override
  public void start(final BaseFragmentView toFragment, @ISupportFragment.LaunchMode int launchMode) {
