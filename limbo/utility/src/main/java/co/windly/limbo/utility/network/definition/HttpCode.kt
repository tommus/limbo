package co.windly.limbo.utility.network.definition

import androidx.annotation.IntDef
import co.windly.limbo.utility.network.definition.HttpCode.Companion.ACCEPTED
import co.windly.limbo.utility.network.definition.HttpCode.Companion.ALREADY_REPORTED
import co.windly.limbo.utility.network.definition.HttpCode.Companion.BAD_GATEWAY
import co.windly.limbo.utility.network.definition.HttpCode.Companion.BAD_REQUEST
import co.windly.limbo.utility.network.definition.HttpCode.Companion.CONFLICT
import co.windly.limbo.utility.network.definition.HttpCode.Companion.CONTINUE
import co.windly.limbo.utility.network.definition.HttpCode.Companion.CREATED
import co.windly.limbo.utility.network.definition.HttpCode.Companion.EARLY_HINTS
import co.windly.limbo.utility.network.definition.HttpCode.Companion.EXPECTATION_FAILED
import co.windly.limbo.utility.network.definition.HttpCode.Companion.FAILED_DEPENDENCY
import co.windly.limbo.utility.network.definition.HttpCode.Companion.FORBIDDEN
import co.windly.limbo.utility.network.definition.HttpCode.Companion.FOUND
import co.windly.limbo.utility.network.definition.HttpCode.Companion.GATEWAY_TIMEOUT
import co.windly.limbo.utility.network.definition.HttpCode.Companion.GONE
import co.windly.limbo.utility.network.definition.HttpCode.Companion.HTTP_VERSION_NOT_SUPPORTED
import co.windly.limbo.utility.network.definition.HttpCode.Companion.IM_A_TEAPOT
import co.windly.limbo.utility.network.definition.HttpCode.Companion.IM_USED
import co.windly.limbo.utility.network.definition.HttpCode.Companion.INSUFFICIENT_STORAGE
import co.windly.limbo.utility.network.definition.HttpCode.Companion.INTERNAL_SERVER_ERROR
import co.windly.limbo.utility.network.definition.HttpCode.Companion.LENGTH_REQUIRED
import co.windly.limbo.utility.network.definition.HttpCode.Companion.LOCKED
import co.windly.limbo.utility.network.definition.HttpCode.Companion.LOOP_DETECTED
import co.windly.limbo.utility.network.definition.HttpCode.Companion.METHOD_NOT_ALLOWED
import co.windly.limbo.utility.network.definition.HttpCode.Companion.MISDIRECTED_REQUEST
import co.windly.limbo.utility.network.definition.HttpCode.Companion.MOVED_PERMANENTLY
import co.windly.limbo.utility.network.definition.HttpCode.Companion.MULTIPLE_CHOICES
import co.windly.limbo.utility.network.definition.HttpCode.Companion.MULTI_STATUS
import co.windly.limbo.utility.network.definition.HttpCode.Companion.NETWORK_AUTHENTICATION_REQUIRED
import co.windly.limbo.utility.network.definition.HttpCode.Companion.NON_AUTHORITATIVE_INFORMATION
import co.windly.limbo.utility.network.definition.HttpCode.Companion.NOT_ACCEPTABLE
import co.windly.limbo.utility.network.definition.HttpCode.Companion.NOT_EXTENDED
import co.windly.limbo.utility.network.definition.HttpCode.Companion.NOT_FOUND
import co.windly.limbo.utility.network.definition.HttpCode.Companion.NOT_IMPLEMENTED
import co.windly.limbo.utility.network.definition.HttpCode.Companion.NOT_MODIFIED
import co.windly.limbo.utility.network.definition.HttpCode.Companion.NO_CONTENT
import co.windly.limbo.utility.network.definition.HttpCode.Companion.OK
import co.windly.limbo.utility.network.definition.HttpCode.Companion.PARTIAL_CONTENT
import co.windly.limbo.utility.network.definition.HttpCode.Companion.PAYLOAD_TOO_LARGE
import co.windly.limbo.utility.network.definition.HttpCode.Companion.PAYMENT_REQUIRED
import co.windly.limbo.utility.network.definition.HttpCode.Companion.PERMANENT_REDIRECT
import co.windly.limbo.utility.network.definition.HttpCode.Companion.PRECONDITION_FAILED
import co.windly.limbo.utility.network.definition.HttpCode.Companion.PRECONDITION_REQUIRED
import co.windly.limbo.utility.network.definition.HttpCode.Companion.PROCESSING
import co.windly.limbo.utility.network.definition.HttpCode.Companion.PROXY_AUTHENTICATION_REQUIRED
import co.windly.limbo.utility.network.definition.HttpCode.Companion.RANGE_NOT_SATISFIABLE
import co.windly.limbo.utility.network.definition.HttpCode.Companion.REQUEST_HEADER_FIELDS_TOO_LARGE
import co.windly.limbo.utility.network.definition.HttpCode.Companion.REQUEST_TIMEOUT
import co.windly.limbo.utility.network.definition.HttpCode.Companion.RESET_CONTENT
import co.windly.limbo.utility.network.definition.HttpCode.Companion.SEE_OTHER
import co.windly.limbo.utility.network.definition.HttpCode.Companion.SERVICE_UNAVAILABLE
import co.windly.limbo.utility.network.definition.HttpCode.Companion.SWITCHING_PROTOCOLS
import co.windly.limbo.utility.network.definition.HttpCode.Companion.SWITCH_PROXY
import co.windly.limbo.utility.network.definition.HttpCode.Companion.TEMPORARY_REDIRECT
import co.windly.limbo.utility.network.definition.HttpCode.Companion.TOO_EARLY
import co.windly.limbo.utility.network.definition.HttpCode.Companion.TOO_MANY_REQUESTS
import co.windly.limbo.utility.network.definition.HttpCode.Companion.UNAUTHORIZED
import co.windly.limbo.utility.network.definition.HttpCode.Companion.UNAVAILABLE_FOR_LEGAL_REASONS
import co.windly.limbo.utility.network.definition.HttpCode.Companion.UNPROCESSABLE_ENTITY
import co.windly.limbo.utility.network.definition.HttpCode.Companion.UNSUPPORTED_MEDIA_TYPE
import co.windly.limbo.utility.network.definition.HttpCode.Companion.UPGRADE_REQUIRED
import co.windly.limbo.utility.network.definition.HttpCode.Companion.URI_TOO_LONG
import co.windly.limbo.utility.network.definition.HttpCode.Companion.USE_PROXY
import co.windly.limbo.utility.network.definition.HttpCode.Companion.VARIANT_ALSO_NEGOTIATES
