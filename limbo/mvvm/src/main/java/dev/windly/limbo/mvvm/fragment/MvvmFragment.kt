...
import dev.windly.limbo.mvvm.trait.ContextTrait
import dev.windly.limbo.mvvm.trait.FragmentNavigationTrait
import dev.windly.limbo.mvvm.trait.FragmentTrait
import dev.windly.limbo.mvvm.viewmodel.LimboViewModel
import io.reactivex.rxjava3.disposables.CompositeDisposable
import java.lang.ref.WeakReference

abstract class MvvmFragment<Binding : ViewDataBinding, VM : LimboViewModel> :
  Fragment(), ContextTrait, FragmentTrait, FragmentNavigationTrait {
